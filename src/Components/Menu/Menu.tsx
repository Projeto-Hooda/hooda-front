          ...
          <div className="hidden md:flex items-center flex-grow">
            ...
            <div className="flex flex-grow justify-center">
              <ul className="flex space-x-4">
                ...
                <li>
                  <Link to={"/contato"} className="py-2 px-3 font-Montserrat text-gray-700 hover:text-white flex items-center">
                    <FontAwesomeIcon icon={faInfoCircle} className="h-6 w-6 mr-2" />
                    Contato
                  </Link>
                </li>
          ...
          <div className={`relative w-64 h-full bg-white transition-transform transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} overflow-y-auto`}>
            ...
            <div className="flex flex-col items-start py-4 px-6 space-y-4">
              ...
              <ul className="flex flex-col w-full space-y-4">
                ...
                <li>
                  <Link to={"/contato"} onClick={closeMenu} className="py-2 px-3 font-Montserrat text-gray-700 hover:text-white flex items-center">
                    <FontAwesomeIcon icon={faInfoCircle} className="h-6 w-6 mr-2" />
                    Contato
                  </Link>
                </li>
