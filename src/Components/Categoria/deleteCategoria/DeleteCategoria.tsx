    ...
    return (
        ...
        <div className='flex justify-center mt-20 mx-2'>
            <div className="relative flex flex-col justify-center text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
                <div className="p-6 ">
                    <h3 className='text-lg font-bold text-center uppercase my-3 font-sans'>Deletar categoria:</h3>
                    <p className='text-xl flex justify-center my-3 font-semibold font-sans'>{categoria.nome}</p>
                    <p className='flex justify-center my-2 font-sans'>({categoria.descricao})</p>
                </div>
                <p className='flex justify-center m-1 font-semibold font-sans'>Tem certeza que você quer deletar {categoria.nome}?</p>
